...
sub ad_admin_edit_example {
	...
	my $edit_form = qq|
		...
		<form name="edittmpl" method="POST" action="%%rootdir%%/admin/ads/edit_example" enctype="multipart/form-data"$accept_charset>
...
sub ad_admin_edit_ad {
	...
	my $edit_form = qq|
		<tr><td>
		<form name="edittmpl" method="POST" action="%%rootdir%%/admin/ads/edit" enctype="multipart/form-data"$accept_charset>
...
sub ad_admin_adprop {
	...
	my $form = qq|
		...
		<form name="edittmpl" method="POST" action="%%rootdir%%/admin/ads/adprop" enctype="multipart/form-data"$accept_charset>
...
sub ad_admin_judge {
	...
	$content = qq{<tr><td>
		<form action="%%rootdir%%/admin/ads/judge" method="POST" name="judgeform"$accept_charset>
		<table border="0" cellpadding="1" cellspacing="1" width="99%">
